...
import {Platform, Alert, FlatList, RefreshControl,TouchableWithoutFeedback,StyleSheet, Text, Modal, View, Button,ImageBackground, TouchableHighlight, TouchableOpacity, Image, Dimensions, ScrollView, TextInput, ActivityIndicator, Share, KeyboardAvoidingView} from 'react-native';
        ...
        if(this.state.itemForTheList!=""){
            ...
            textInput.push(
                    <TextInputComponent
                        ...
                        placeholder="Item"
                        key={{key}}
                        style={{height: ((height/100)*10),alignItems:'stretch',fontSize:30,borderWidth:1,margin:5}}
                    ...
                    <Row size={3} alignItems="center" justifyContent="center">
                        ...
                        {/* <RefreshControl
                            ...
                            <KeyboardAvoidingView style={{
                                    ...
                                    alignItems: 'stretch'}} behavior="padding" enabled>
                            
                            {
                                (this.state.listDone)?
                                <TextInput
                                style={{height: 40,margin:30,fontSize:30,padding:3}}
